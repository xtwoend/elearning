...
use Xtwoend\Component\Calendar\Events\Event;
use Xtwoend\Component\Calendar\Events\SimpleEvent;
use Xtwoend\Component\Calendar\Events\EventCollection;
...
class Calendar
{
     ...
     */
    public function __construct(Factory $view, EventCollection $eventCollection, EventRepository $eventRepository)
    {
        $this->view            = $view;
    ...
    {
        return '<div id="calendar-' . $this->getId() . '" class="bg-white"></div>';
    }
    ...
    /**
     * [userEvents description]
     * @param  [type] $user_id          [description]
     * @param  array  $customAttributes [description]
     * @return [type]                   [description]
     */
    public function userEvents($user_id, array $customAttributes = [])
    {
        $events = $this->eventRepository->findByUserId($user_id);
