...
var DemoAdapterConstants = (function () {
    ...
    DemoAdapterConstants.ME_USER_ID = 3;
...
var ServerAdapter = (function () {
    function ServerAdapter(clientAdapter) {
        ...
        // Echobot is the guy that will repeat everything you say
        var userMe = new ChatUserInfo();
        userMe.Id = DemoAdapterConstants.ME_USER_ID;
        userMe.RoomId = DemoAdapterConstants.DEFAULT_ROOM_ID;
        userMe.Name = "Xtwoed";
        userMe.Email = "aditans88@gmail.com";
        userMe.ProfilePictureUrl = "http://www.gravatar.com/avatar/4ec6b20c5fed48b6b01e88161c0a3e20.jpg";
        userMe.Status = 1 /* Online */;
    ...
    ServerAdapter.prototype.sendMessage = function (roomId, conversationId, otherUserId, messageText, clientGuid, done) {
        var _this = this;
        console.log("ServerAdapter: sendMessage");
    ...
    ServerAdapter.prototype.sendTypingSignal = function (roomId, conversationId, userToId, done) {
        console.log("ServerAdapter: sendTypingSignal");
    };

    ServerAdapter.prototype.getMessageHistory = function (roomId, conversationId, otherUserId, done) {
        console.log("ServerAdapter: getMessageHistory");
        done([]);
    };

    ServerAdapter.prototype.getUserInfo = function (userId, done) {
        console.log("ServerAdapter: getUserInfo");
        var user = null;
    ...
    ServerAdapter.prototype.getUserList = function (roomId, conversationId, done) {
        console.log("ServerAdapter: getUserList");
    ...
    ServerAdapter.prototype.enterRoom = function (roomId, done) {
        console.log("ServerAdapter: enterRoom");
    ...
    ServerAdapter.prototype.leaveRoom = function (roomId, done) {
        console.log("ServerAdapter: leaveRoom");
    };
...
var SocketAdapter = (function () {
    ...
    SocketAdapter.prototype.init = function (done) {
